  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className={cn('flex flex-col items-center justify-center', headingFont.className)}>
        <div className="border-sm mb-4 flex items-center rounded-full bg-amber-100 p-4 text-amber-700 uppercase shadow-sm">
        ...
        <div className="w-fit rounded-md bg-gradient-to-r from-fuchsia-600 to-pink-600 p-2 px-4 pt-3 text-3xl text-white md:text-6xl">
          work forward.
        </div>
      </div>
      <div
